...
// This example is lovingly borrowed from
// https://swiftui-lab.com/swiftui-animations-part1/, the first in an excellent
// series of articles about animation in SwiftUI.
...
struct LetterSizeAnimationDemoView: View {
  ...
  var body: some View {
    VStack {
      Spacer()
      WaveText("The SwiftUI Lab", waveWidth: 6, pct: flag ? 1.0 : 0.0)
        .foregroundColor(.blue)
        .frame(height: 40)
      WaveText("swiftui-lab.com", waveWidth: 6, pct: flag ? 0.0 : 1.0, size: 18)
