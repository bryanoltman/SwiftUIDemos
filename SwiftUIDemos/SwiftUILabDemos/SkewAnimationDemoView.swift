...
// Example 7 from https://swiftui-lab.com/swiftui-animations-part2/

struct SkewAnimationDemoView: View {
  ...
  var body: some View {
    ...
    return VStack {
      LabelView(text: "The SwiftUI Lab",
      ...
      Button("Animate") { self.moveIt.toggle() }
      .padding(.top, 50)
    }
...
struct LabelView: View {
  ...
  var body: some View {
    Text("The SwiftUI Lab")
      ...
      .modifier(
        SkewedOffset(offset: offset, pct: pct, goingRight: offset > 0)
    )
  }
}
